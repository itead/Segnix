...
/* You should comment this line below after test ok */
#if 0
#define DEBUG_ON
#endif
...
/* Maybe we should change GSM_ON and GSM_RESET pin for our board */
// pins definition
#if 0 //
#define GSM_ON              11 // connect GSM Module turn ON to pin 11
#else
//uint16_t GSM_ON=11;
#endif

#if 0 // disabled by wpf
#define GSM_RESET           12 // connect GSM Module RESET to pin 12
#endif

/* DTMF_* Micro are not used */
...
public:
     ...
     #endif
     #if 1 // add by wpf
     GSM(uint16_t gsm_on,Serial_ &Serial);
     GSM(uint16_t gsm_on, uint16_t gsm_rst, Serial_ &Serial);
     #endif
