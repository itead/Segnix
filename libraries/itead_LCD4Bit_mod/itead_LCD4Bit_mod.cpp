...
static int DB[] = {4, 5, 6, 7};  //wire these to DB4~7 on LCD.
#else
//RS, RW and Enable can be set to whatever you like
static int RS = 15;	//PD6
static int RW = 111; //PI12
static int Enable = 16; //PD7
//DB should be an unseparated group of pins  - because of lazy coding in pushNibble()
static int DB[] = {11, 12, 13, 14};  //wire these to DB4~7 on LCD.

#endif
//--------------------------------------------------------

//how many lines has the LCD? (don't change here - specify on calling constructor)
static int g_num_lines = 2;
